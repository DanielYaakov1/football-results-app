...
export const About: React.FC = memo(() => {
  ...
  return (
    <div className={classes.container}>
      <div className={classes.leftSideTextContainer}>
        ...
        <p className={classes.description}>
          ...
          numquam illo. Optio sit provident ipsam reiciendis autem ullam ducimus
          minus alias numquam?
        </p>
        <p className={classes.description}>
          ...
          utility to apply custom styles to our components, ensuring a sleek and
          responsive user interface.
        </p>
        <p className={classes.description}>
          Stay connected with the world of football and never miss a beat with
          the Football Results App. Download it now and enjoy the excitement of
          every match! Stay connected with the world of football and never miss
          a beat with the Football Results App. Download it now and enjoy the
